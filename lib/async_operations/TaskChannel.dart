...
class TaskChannel {
  static Future _createTasksInBothLocalAndServer(String customer, String authorization, String userId) async {
    try{
  ...
  static Future _updateTaskInBothLocalAndServer(String customer, String authorization) async {
    try{
  ...
  static Future _deleteTaskInBothLocalAndServer(String customer, String authorization) async {
    try{
      http.Response tasksFromServerRes = await getAllTasksFromServer(customer, authorization, perPage: '10000');
      TasksModel tasksFromServer = TasksModel.fromJson(tasksFromServerRes.body);
